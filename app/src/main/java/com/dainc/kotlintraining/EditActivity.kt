...
class EditActivity : AppCompatActivity() {
    ...
    private var dataAdapter2: ArrayAdapter<GenderModel>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spRole!!.setSelection(dataAdapter.getPosition(roleList!![selectedUser!!.getAuthorityId()]))
        ...
        if (selectedUser!!.getAge() === 0)
            ...
            edtAge!!.setText(selectedUser!!.getAge().toString())
        cbAdmin!!.isChecked = selectedUser!!.getAdmin() === 1
        ...
        btnEdit!!.setOnClickListener(View.OnClickListener {
            ...
            AlertDialog.Builder(this@EditActivity)
                ...
                .setPositiveButton(
                    "OK"
                ) { dialog, which -> editUser(IPConfig.EDIT_USER) }
        ...
        val stringRequest = object : StringRequest(Request.Method.GET, url,
            Response.Listener { response ->
                ...
                try {
                    ...
                    val i = Intent(this@EditActivity, LoginActivity::class.java)
                ...
                spGender!!.setSelection(dataAdapter2!!.getPosition(genderList!![selectedUser!!.getGenderId()]))
            },
            Response.ErrorListener { Toast.makeText(this@EditActivity, "Lỗi mạng", Toast.LENGTH_SHORT).show() }
        ) {
    ...
    private fun editUser(url: String) {
        ...
        val stringRequest = object : StringRequest(Request.Method.POST, url,
            Response.Listener { response ->
                ...
                try {
                    ...
                    if (status == "edit_success") {
                        makeToask("更新できた。", Color.BLUE)
                        val intent = Intent(this@EditActivity, EditSuccessActivity::class.java)
                        intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
                        startActivity(intent)
                        finish()
                    } else if (status == "not_haved") {
            ...
            override fun getParams(): Map<String, String> {
                ...
                params["userId"] = tvUserId!!.text.toString()
